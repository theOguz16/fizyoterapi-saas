...
function main() {
  ...
  requireSourceContains("app/page.tsx", /Kurulum bilgileri/, "home setup/readiness section");
  requireSourceContains("app/page.tsx", /Satın alma nedeni/, "home conversion section");
  requireSourceContains("app/page.tsx", /Paket beklentisi/, "home package expectation section");
  requireSourceContains("app/page.tsx", /Büyüme ölçümü/, "home ROI section");
