...
export default function TrainerRequestCenterScreen() {
  ...
  return (
    <AppShell title="Değişiklik merkezi" subtitle="Ders saati değişikliklerini bekleyen, onaylanan ve reddedilen olarak takip et." icon="calendar" showBackButton refreshing={query.isRefetching} onRefresh={() => void query.refetch()}>
